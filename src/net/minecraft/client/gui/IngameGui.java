...
import ru.fougest.client.command.impl.GPSCommand;
...
import ru.fougest.client.modules.impl.render.Crosshair;
...
public class IngameGui extends AbstractGui {
    ...
    public void renderIngameGui(MatrixStack matrixStack, float partialTicks) {
        ...
        if (Managment.FUNCTION_MANAGER.hud.elements.get(4)) {
