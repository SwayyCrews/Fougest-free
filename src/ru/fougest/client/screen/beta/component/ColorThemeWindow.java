...
public class ColorThemeWindow {
    ...
    public void draw(MatrixStack stack, int mouseX, int mouseY) {
        ...
        RenderUtil.Render2D.drawShadow(pos.x + pos.z - 10 + 8 / 2f, pos.y + pos.w / 2f + 8 / 2f, 228 / 2f, 321 / 2f, 9, DWTheme.typeColor);

        RenderUtil.Render2D.drawRoundedCorner(pos.x + pos.z - 10 + 8 / 2f, pos.y + pos.w / 2f + 8 / 2f, 228 / 2f, 321 / 2f, 3, DWTheme.typeColor);
        ...
        RenderUtil.Render2D.drawRoundedCorner(x + 4, y + 321 / 2f - 36 / 2f - 4, 102 / 2f, 36 / 2f, 3, DWTheme.bgColor);
        RenderUtil.Render2D.drawRoundedCorner(x + 4 + 51 + 4, y + 321 / 2f - 36 / 2f - 4, 102 / 2f, 36 / 2f, 3, DWTheme.bgColor);
