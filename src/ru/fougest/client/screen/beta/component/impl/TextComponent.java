...
public class TextComponent extends Component {
    ...
    public void drawComponent(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        float width = Fonts.rubikSemiBold[14].getWidth(text) + 4;
        RenderUtil.Render2D.drawRoundedCorner(x + 5, y + 2, width, 10, 2, DWTheme.bgColor);
        Fonts.rubikSemiBold[14].drawCenteredString(matrixStack, text, x + 5 + (width / 2), y + 6, DWTheme.textColor);
        Fonts.rubikSemiBold[14].drawString(matrixStack, setting.getName(), x + 5 + width + 3, y + 6, DWTheme.textColor);
    }
