package ru.fougest.client.screen.beta.component;

import com.mojang.blaze3d.matrix.MatrixStack;
import net.minecraft.util.math.MathHelper;
import ru.fougest.client.screen.beta.component.impl.ColorComponent;
...
public class ColorWindow {
    ...
    public void draw(MatrixStack stack, int mouseX, int mouseY) {
        ...
        RenderUtil.Render2D.drawShadow(component.x + component.width - 10 + 8 / 2f, component.y + component.height / 2f + 8 / 2f, 228 / 2f, 321 / 2f, 9, DWTheme.bgColor);

        RenderUtil.Render2D.drawRoundedRect(component.x + component.width - 10 + 8 / 2f, component.y + component.height / 2f + 8 / 2f, 228 / 2f, 321 / 2f, 3, DWTheme.bgColor);
        ...
        RenderUtil.Render2D.drawRoundedRect(x + 4, y + 321 / 2f - 36 / 2f - 4, 102 / 2f, 36 / 2f, 3,DWTheme.typeColor);
        RenderUtil.Render2D.drawRoundedRect(x + 4 + 51 + 4, y + 321 / 2f - 36 / 2f - 4, 102 / 2f, 36 / 2f, 3,DWTheme.typeColor);
        Fonts.rubikSemiBold[14].drawCenteredString(stack, "Copy", x + 4 +51 / 2f, y + 321 / 2f - 14.5f, DWTheme.textColor);
        Fonts.rubikSemiBold[14].drawCenteredString(stack, "Paste", x + 4 + 51 + 4 +51 / 2f, y + 321 / 2f - 14.5f, DWTheme.textColor);
