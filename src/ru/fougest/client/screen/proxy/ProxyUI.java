package ru.fougest.client.screen.proxy;
...
import ru.fougest.other.proxy.ProxyType;
...
public class ProxyUI extends Screen {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        Fonts.rubikSemiBold[14].drawCenteredString(matrixStack, "Активный прокси: " + cProxy, center[0], center[1] - 30, -1);

        Fonts.rubikSemiBold[14].drawCenteredString(matrixStack, "Пример: socks4://123.123.123.123:1234", center[0], center[1] + 60, -1);
