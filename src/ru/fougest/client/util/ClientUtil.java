...
public class ClientUtil implements IMinecraft {
    ...
    static IPCClient client = new IPCClient(1181648336126742548L);
    ...
    public static void startRPC() {
        ...
        client.setListener(new IPCListener(){
            ...
            public void onReady(IPCClient client)
            {
                ...
                builder.setDetails("ver: free")
                        .setStartTimestamp(OffsetDateTime.now())
                        .setLargeImage("eilw189iwoid1872d", "always on top");
    ...
    public static void sendMesage(String message) {
        ...
        mc.player.sendMessage(gradient("Fougest Client", new java.awt.Color(90, 105, 255).getRGB(), new java.awt.Color(245, 98, 255).getRGB()).append(new StringTextComponent(TextFormatting.DARK_GRAY + " -> " + TextFormatting.RESET + message)), Util.DUMMY_UUID);
    }
