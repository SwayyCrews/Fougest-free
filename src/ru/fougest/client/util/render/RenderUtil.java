package ru.fougest.client.util.render;
...
import ru.fougest.client.modules.impl.util.Optimization;
...
import static ru.fougest.client.util.render.RenderUtil.IntColor.*;
import static ru.fougest.client.util.render.ShaderUtil.*;
    ...
    public static class Render2D {
        ...
        public static void drawFace(float d,
            ...
            try {
                ...
                drawTexture(d, y, width, height, 4,1);
