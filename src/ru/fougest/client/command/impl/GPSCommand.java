...
import static ru.fougest.client.util.render.RenderUtil.Render2D.drawShadow;
import static ru.fougest.client.util.render.RenderUtil.Render2D.drawTriangle;
...
public class GPSCommand extends Command {
    ...
    public static void drawArrow(MatrixStack stack) {
        ...
        Fonts.rubikSemiBold[14].drawCenteredStringWithOutline(stack, "Навигатор", 0, 7, -1);

        Fonts.rubikSemiBold[14].drawCenteredStringWithOutline(stack, (int) dst + "m", 0, 15, -1);
