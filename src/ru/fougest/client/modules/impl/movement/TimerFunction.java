...
public class TimerFunction extends Function {
    ...
    public void renderTimer(MatrixStack stack, MainWindow window) {
        ...
        Fonts.rubikSemiBold[16].drawString(stack, "Timer", x + 5, y + 4.5f, RenderUtil.IntColor.rgba(200, 200, 200, 255));
        Fonts.rubikSemiBold[12].drawCenteredString(stack, value + "%", x + (width / 2), y + 14 + 6 / 2 - 1, -1);
    }
