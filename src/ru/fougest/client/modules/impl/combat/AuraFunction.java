...
import ru.fougest.client.events.impl.player.EventInteractEntity;
...
import ru.fougest.client.util.math.AuraUtil;
import ru.fougest.client.util.math.GCDUtil;
import ru.fougest.client.util.math.RayTraceUtil;
...
import static ru.fougest.client.util.math.MathUtil.calculateDelta;
...
@FunctionAnnotation(name = "Aura", type = Type.Fight)
