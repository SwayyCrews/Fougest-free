...
import ru.fougest.client.events.impl.player.EventLivingUpdate;
...
import ru.fougest.client.util.FreeCamera;
...
public class FreeCam extends Function {
    ...
    private void handleRender2DEvent(EventRender renderEvent) {
        ...
        Fonts.rubikSemiBold[16].drawCenteredStringWithOutline(renderEvent.matrixStack,
                position,
