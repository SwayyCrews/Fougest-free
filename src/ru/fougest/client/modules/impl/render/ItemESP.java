...
import static ru.fougest.client.util.render.RenderUtil.Render2D.drawMCVertical;
        ...
        for (Map.Entry<Vector4d, ItemEntity> entry : positions.entrySet()) {
            ...
            if (position != null) {
                ...
                if (elements.get(1)) {
                        ...
                        Fonts.rubikSemiBold[10].drawStringWithShadow(stack, tag, (x + ((endX - x) / 2) - Fonts.rubikSemiBold[10].getWidth(tag) / 2),
                                y - 5, -1);
